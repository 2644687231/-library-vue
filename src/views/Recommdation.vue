...
export default {
  ...
  methods: {
    ...
    deleteBatch() {
      ...
      request.post("Recommdation/deleteRecords", this.forms).then(res => {
        if (res.code === '0') {
    ...
    load() {
      request.get("/Recommdation/select/" + this.user.userid, {}).then(res => {
        console.log(res);
    ...
    handleDelete(row) {
      ...
      request.post("Recommdation/deleteRecord", form3).then(res => {
        console.log(res)
        if (res.code === 0) {
    ...
    save() {
      ...
      request.post("/Recommdation", this.form).then(res => {
        console.log(res)
        if (res.code === 0) {
          ElMessage({
            message: '修改信息成功',
